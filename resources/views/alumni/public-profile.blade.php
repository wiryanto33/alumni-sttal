                            ...
                            <div class="d-flex align-items-center flex-wrap g-18 pb-30 border-item-one">
                                <div class="zUser-one">
                                    ...
                                    @if (!$user->currentMembership == null)
                                        <div class="zBadge"><img src="{{ getFileUrl($user->currentMembership->badge)}}"
                                                                 alt=""/></div>
                                    @endif
                                </div>
                                <div class="">
                                            ...
                                            <li>
                                                <a target="__blank" href="{{ $user->alumni?->facebook_url }}"
                                                   class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white bg-fafafa hover-bg-two hover-border-one"><img
                                                            src="{{ asset('assets/images/icon/facebook-2.svg')}}"
                                                            alt=""/></a>
                                            </li>
                                        @endif
                                        @if($user->alumni?->twitter_url != NULL && $user->alumni?->twitter_url != '')
                                            <li>
                                                <a target="__blank" href="{{ $user->alumni?->twitter_url }}"
                                                   class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white bg-fafafa hover-bg-two hover-border-one"><img
                                                            src="{{ asset('assets/images/icon/twitter-2.svg')}}"
                                                            alt=""/></a>
                                            </li>
                                        @endif
                                        @if($user->alumni?->linkedin_url != NULL && $user->alumni?->linkedin_url != '')
                                            <li>
                                                <a target="__blank" href="{{ $user->alumni?->linkedin_url }}"
                                                   class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white bg-fafafa hover-bg-two hover-border-one"><img
                                                            src="{{ asset('assets/images/icon/linkedin-2.svg')}}"
                                                            alt=""/></a>
                                            </li>
                                        @endif
                                        @if($user->alumni?->instagram_url != NULL && $user->alumni?->instagram_url != '')
                                            <li>
                                                <a target="__blank" href="{{ $user->alumni?->instagram_url }}"
                                                   class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white bg-fafafa hover-bg-two hover-border-one"><img
                                                            src="{{ asset('assets/images/icon/instagram-2.svg')}}"
                                                            alt=""/></a>
                                            </li>
                                        @endif
                                    </ul>
                        ...
                        <div class="col-lg-6 col-md-7">
                            ...
                            <ul class="zList-two pb-30">
                                @if($user->show_phone_in_public == STATUS_SUCCESS)
                                    <li>
                                        <div class="icon"><img src="{{ asset('assets/images/icon/phone.svg')}}" alt=""/>
                                        </div>
                                        <p>{{ $user->mobile }}</p>
                                    </li>
                                @endif
                                @if($user->show_email_in_public == STATUS_SUCCESS)
                                    <li>
                                        <div class="icon"><img src="{{ asset('assets/images/icon/envelope-1.svg')}}"
                                                               alt=""/></div>
                                        <p>{{ $user->email }}</p>
                                    </li>
                                @endif
                        ...
                        <div class="py-20 px-25 bd-ra-10 bg-f9f9f9">
                            ...
                            <div class="pb-25 mb-25 bd-b-one bd-c-ededed">
                                ...
                                @if($regForm->enable_batch)
                                    <li>
                                        <p>{{ __('Batch') }} :</p>
                                        <p>{{ $user->alumni?->batch?->name }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_department)
                                    <li>
                                        <p>{{ __('Department') }} :</p>
                                        <p>{{ $user->alumni?->department?->name }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_passing_year)
                                    <li>
                                        <p>{{ __('Passing Year') }} :</p>
                                        <p>{{ $user->alumni?->passing_year?->name }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_role_number)
                                    <li>
                                        <p>{{ __('Roll Number') }} :</p>
                                        <p>{{ $user->alumni?->id_number }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_blood_group)
                                    <li>
                                        <p>{{ __('Blood Group') }} :</p>
                                        <p>{{ $user->alumni?->blood_group }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_date_of_birth)
                                    <li>
                                        <p>{{ __('Date of Birth') }} :</p>
                                        <p>{{ $user->alumni?->date_of_birth }}</p>
                                    </li>
                                @endif
                                @if($regForm->enable_gender)
                                    <li>
                                        <p>{{ __('Gender') }} :</p>
                                        <p>{{ $user->alumni?->gender }}</p>
                                    </li>
                                @endif
                                <li>
                                    <p>{{ __('City') }} :</p>
                                ...
                                @if ($regForm->enable_attachment && auth()->user()->role == USER_ROLE_ADMIN)
                                    <li>
                                        <p>{{ __('Attachment') }} :</p>
                                        <a target="__blank" class="text-afd449"
                                           href="{{getFileUrl($user->alumni?->file)}}">{{__('View')}}</a>
                                    </li>
                                @endif
                                @if ($user->alumni?->custom_fields)
                                    @foreach(json_decode($user->alumni?->custom_fields ?? []) as $dynamicField)
                                        <li>
                                            <p>{{ __($dynamicField->label) }} :</p>
                                            <p>{{implode(',', $dynamicField->userData)}}</p>
                                        </li>
                                    @endforeach
                                @endif
                            </ul>
