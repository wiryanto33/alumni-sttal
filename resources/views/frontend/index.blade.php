...
@section('content')
    ...
    <section class="pb-110">
        <div class="container">
            <div class="welcomeSpeech-wrap">
                <div class="img"><img src="{{asset(getFileUrl(getOption('welcome_speech_image')))}}" alt=""></div>
                <div class="content">
                    <h4 class="title">{{ getOption('welcome_speech_title') }}</h4>
                    <p class="info">{!! getOption('welcome_speech_description') !!}</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hover-scale-img bd-one bd-c-black-10 bd-ra-25 bg-event-bg hover-scale-img">
                            <div class="bd-ra-14 overflow-hidden h-234 position-relative">
                                ...
                                <p
                                    class="frontendNews position-absolute top-22 left-22 p-10 bd-ra-10 bg-primary-color max-w-77 fs-16 fw-400 lh-19 text-black-color text-center">
